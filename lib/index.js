    ...
    return function () {
        try {
            ...
            if (e instanceof Promise) {
                var instance = this;
                var instanceI = instances.indexOf(instance);
                if (instanceI === -1 || catchDefers[instanceI].indexOf(e) === -1) {
                    if (instanceI === -1) {
                        instances.push(instance);
                        instanceI = instances.length - 1;
                        catchDefers[instanceI] = [];
                    }
                    catchDefers[instanceI].push(e);
...
module.exports.createReduxFetcher = require('./redux').createReduxFetcher;
